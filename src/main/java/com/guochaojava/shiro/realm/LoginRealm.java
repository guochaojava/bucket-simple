...
public class LoginRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        //2.从数据库中获取权限数据
        Set<String> roles = userService.selectRolesByLoginName(loginUser.getLoginName());
        Set<String> permissions = userService.selectPermissionsByLoginName(loginUser.getLoginName());
