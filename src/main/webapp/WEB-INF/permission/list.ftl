    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <section class="panel panel-padding">
                <form class="layui-form" data-params='{"dataName":"permission","action":"list"}'
            ...
            <section class="panel panel-padding">
                ...
                <@shiro.hasPermission name="permission:delete">
                    <button class="layui-btn layui-btn-small layui-btn-danger ajax-all"
                            data-params='{"url": "${base}/permission/delete","confirm":"true","dataName":"permission","key":"id","action":"del"}'>
                        <i class="iconfont">&#xe626;</i> 删除
                    </button>
                </@shiro.hasPermission>
                <@shiro.hasPermission name="permission:add">
                    <button class="layui-btn layui-btn-small modal"
                            data-params='{"content":".add-subcat","data":"level=0","area":"600px,430px","title":"添加权限","action":"add"}'>
                        <i class="iconfont">&#xe649;</i> 添加
                    </button>
                </@shiro.hasPermission>
                </div>
                <div class="layui-form">
                    <table id="example" class="layui-table jq-even" data-params='{"dataName":"permission","key":"id"}'>
                        <thead>
                        <tr>
...
<div class="add-subcat">
    <form id="form1" class="layui-form"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="sort" required jq-verify="number" value="100" jq-error="排序必须为数字"
...
<script id="list-tpl" type="text/html"
        data-params='{"url":"${base}/permission/list","dataName":"permission","select":"#select-tpl","selectid":"#pid-select"}'>
...
<script id="select-tpl" type="text/html" data-params='{"dataName":"permission"}'>
    ...
    {{# layui.each(d.list, function(index, item){ }}
    <option value="{{ item.id}}" data-level="{{ item.level}}"> {{ strRepeat('&nbsp;&nbsp;',item.level)}} {{#
